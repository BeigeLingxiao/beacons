...
/** \internal
  ...
  */
        ...
        struct scalar_cast_op {
            ...
            EIGEN_STRONG_INLINE const NewType
 ...
 */
        ...
        struct scalar_multiple2_op {
            ...
            operator()(const Scalar1 &a) const {
                return a * m_other;
            }
...
// nested expressions).
        ...
        struct linspaced_op {
            ...
            linspaced_op(const Scalar &low, const Scalar &high, DenseIndex num_steps)
                    : impl((num_steps == 1 ? high : low), (num_steps == 1 ? Scalar() : (high - low) / (num_steps - 1))) {
            }
...
{
enum {
    Cost = functor_traits<T>::Cost, PacketAccess = false
}; };
